...
//     try {
//       const kingdom = await program.account.kingdom.fetch(new PublicKey(kingdomPublicKey));
...
//       const tx = await program.methods.createKingdomInvite(new BN(7)) // 7 days expiration
//         .accounts({
...
//       const inviteLink = `${process.env.NEXT_PUBLIC_BASE_URL}/join/absolute-monarchy/${invitePda.toBase58()}`;
