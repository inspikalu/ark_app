...
// import { PolycentricClient, usePolycentricClient } from '../../client/polycentric/initializePolycentric';
...
//       const nftConfig: GovernanceTokenConfig | null = nftTokenType === 'new'
//         ? { token_type: { new: {} } }
//         : { token_type: { existing: {} } };

//       const splConfig: GovernanceTokenConfig | null = splTokenType === 'new'
//         ? { token_type: { new: {} } }
//         : { token_type: { existing: {} } };
